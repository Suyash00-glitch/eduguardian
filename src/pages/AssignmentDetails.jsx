...
function AssignmentDetails() {
  ...
  const assignment = demoAssignmentList.find(
        ...
        <section className="assignment-detail-card">
          ...
          {isSubmitted && (
            <div className="assignment-submitted-state">
              ...
              <span>Submitted on {formatDateTime(assignment.submittedAt)}</span>
      ...
      <section className="assignment-detail-card assignment-attachments">
        ...
        <div className="assignment-resource-item">
          ...
          <div>
            ...
            <span>PDF · Provided by mentor</span>
          </div>

          <button type="button" className="resource-action">
            View
          </button>
        </div>
      </section>
