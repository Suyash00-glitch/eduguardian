    ...
    <div className="insights-page">
      ...
      <section className="insight-summary">
        ...
        <div className="insight-risk">
          ...
          <strong className={`risk-${data.riskLevel}`}>{data.riskLevel}</strong>
        </div>
      </section>
      ...
      <section className="insight-recovery">
        <div>
          <span className="section-eyebrow">RECOVERY PROBABILITY</span>

          <h3>How likely are you to stay on track?</h3>

          <p>
            This estimate is based on recent academic engagement patterns. It is
            designed to provide support, not to label or penalize you.
          </p>
        </div>
