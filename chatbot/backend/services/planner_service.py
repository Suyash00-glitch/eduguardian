...
PLANNER_CARD = AgentCard(
    ...
    supported_interfaces=[
        ...
        AgentInterface(url="http://localhost:8002/", protocol_binding="HTTP+JSON"),
    ],
    skills=[
        AgentSkill(
...
def create_planner_service_app() -> FastAPI:
    ...
    async def get_card_legacy() -> dict:
        return MessageToDict(PLANNER_CARD)
    ...
    add_a2a_routes_to_fastapi(
        app,
        agent_card_routes=create_agent_card_routes(PLANNER_CARD),
