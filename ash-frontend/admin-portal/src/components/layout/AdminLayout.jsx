...
const ADMIN_NAV = [
  ...
  { to: "/mentor-management", label: "Mentor Management", icon: ShieldCheck },
  ...
  return (
    <div className="student-layout">
      <aside className="sidebar">
        ...
        {/* TOP TEACHER PROFILE CARD WITH QUICK LOGOUT */}
        <div className="sidebar-teacher-card">
          <div className="teacher-avatar">SJ</div>
          <div className="teacher-meta">
            <strong>Dr. Sarah Jenkins</strong>
            <span>Faculty · {active.department || "ISE"}</span>
          </div>
          <button
            type="button"
        ...
        {/* ALWAYS PINNED VISIBLE LOGOUT AT BOTTOM */}
        <div className="sidebar-bottom">
          <button className="logout-button" onClick={handleLogout} title="Log out of Teacher Portal">
            <LogOut size={16} />
      ...
      <div className="main-area">
        <header className="topbar">
          ...
          <div className="topbar-actions">
            ...
            <button className="topbar-profile" onClick={handleLogout} title="Click to log out">
            ...
            <button className="topbar-logout-button" onClick={handleLogout} title="Log out of Teacher Portal">
              <LogOut size={14} />
              <span>Logout</span>
            </button>
          </div>
